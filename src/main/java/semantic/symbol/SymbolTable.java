...
public class SymbolTable {
    ...
    public void addField(String fieldName, String className) {
        klasses.get(className).Fields.put(fieldName, new Symbol(lastType, mem.addData()));
    }
...
//        try {
        ...
        klasses.get(className).Methodes.get(methodName).localVariable.put(localVariableName, new Symbol(lastType, mem.addData()));
...
//        }
    ...
    class Method {
        ...
        public Method(int codeAddress, SymbolType returnType) {
            ...
            this.returnAddress = mem.addData();
            this.callerAddress = mem.addData();
        ...
        public void addParameter(String parameterName) {
            parameters.put(parameterName, new Symbol(lastType, mem.addData()));
